const TOOLS = [
  ...
  { name: 'vibeboard.flash_ble_ota', status: 'available', transports: ['stdio', 'bridge', 'optional-browser'] },
  { name: 'vibeboard.render_lvgl_preview', status: 'available', transports: ['stdio'] },
  { name: 'vibeboard.collect_device_evidence', status: 'available', transports: ['stdio'] },
]
